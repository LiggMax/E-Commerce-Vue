...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    AuthDialog: typeof import('./components/client/dialog/AuthDialog.vue')['default']
    ...
    ProductEditDialog: typeof import('./components/admin/ProductEditDialog.vue')['default']
